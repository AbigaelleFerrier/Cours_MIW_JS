...
/******************************************************************************************************/		
		...
		extend(Array.prototype,{
			...
			max 	:	function(){
							...
							if (this.length != 0) {
								for (let i = 0; i < this.length; i++) {
									if (!Reg["digitSign"].test(this[i])) { err = true;  }
							...
							if (!err) {
								...
								console.log('Tableau vide ou valeur incorecte a l\'interieur');
							}
						},
			...
			avg		: 	function() {
							...
							// RETOUR
							if (!err) {
								return (avg / this.length).toFixed(2);
							}
							else {
								console.log('Tableau vide ou valeur incorecte a l\'interieur');
							}
...
/******************************************************************************************************/		
		extend(Node.prototype,{
			...
			Acss 	: 	function(obj) {          // permet d'affecter au noeud les propri�t�s de style contenues dans l'objet obj
							for( let i in obj ){
								this.style[i] = obj[i];
							};
							return this;
